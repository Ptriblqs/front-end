              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(judul, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                    const SizedBox(height: 8),
                    ...
                    children: [
                      if (acceptedList.isNotEmpty) ...[
                        const Padding(
                          ...
                          child: Text('Jadwal Disetujui', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        ),
